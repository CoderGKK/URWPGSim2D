...
// Date: 20120422 Author: ChenXiao
// Modification: 
// 1.InitDynacimObstacles动态生成配置文件
// 2.ResetDynamicObstacles中调用InitDynacimObstacles，以便热加载xml参数
// ……
//-----------------------------------------------------------------------
...
namespace URWPGSim2D.Match
{
    ...
    /// </summary>
    [Serializable]
    public class NewFish2V2BallRace : RoboFish
    {
    ...
    /// </summary>
    [Serializable]
    public class NewEnvironment2V2BallRace : SimEnvironment
    {
    ...
    /// </summary>
    [Serializable]
    public partial class NewMatch2V2BallRace : Mission
    {
        #region Singleton设计模式实现让该类最多只有一个实例且能全局访问
        private static NewMatch2V2BallRace instance = null;
        ...
        public static NewMatch2V2BallRace Instance()
        {
            if (instance == null)
            {
                instance = new NewMatch2V2BallRace();
            }
            return instance;
        }
        ...
        /// </summary>
        public List<Team<NewFish2V2BallRace>> Teams = new List<Team<NewFish2V2BallRace>>();

        /// <summary>
        ///  仿真使命（比赛或实验项目）所使用的具体仿真环境
        /// </summary>
        public NewEnvironment2V2BallRace Env = new NewEnvironment2V2BallRace();
        private int[] bs={3,3,3,1,1,1,1,2,2};
        #endregion
        ...
        private void InitTeamsAndFishes()
        {
            for (int i = 0; i < CommonPara.TeamCount; i++)
            {
                ...
                Teams.Add(new Team<NewFish2V2BallRace>());
                ...
                for (int j = 0; j < CommonPara.FishCntPerTeam; j++)
                {
                    ...
                    Teams[i].Fishes.Add(new NewFish2V2BallRace());
        ...
        public override void ResetBalls()
        {
            ...
            Env.Balls[4].ColorBorder = Color.DarkOrange;
